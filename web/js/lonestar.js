function lonestar_t(key)
{
	if(key)
		this.key=to_hex_string(hash_sha3_512(key));
}
...
function hash_sha3_512(message)
{
	return CryptoJS.SHA3(message);
}

function hmac_sha3_512(key,plain)
{
	return hash_sha3_512(key+plain);
}